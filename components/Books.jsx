  ...
  return (
    <div className="group [perspective:1000px]">
      <div className="relative transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
        ...
        <div className="absolute inset-0 rounded-xl bg-gray/70 px-8 text-center text-slate-200 [transform:rotateY(180deg)] [backface-visibility:hidden]">
...
const Books = () => {
  return (
    <div id="books" className="w-full h-full flex items-center py-16 px-10">
      <div className="max-w-4xl mx-auto h-screen">
        <p className="uppercase text-xl tracking-widest text-gray-300">Books</p>
